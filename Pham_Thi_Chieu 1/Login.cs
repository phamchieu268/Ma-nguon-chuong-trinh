    ...
    public partial class Login : Form
    {
        ...
        private void btn_Dangnhap_Click(object sender, EventArgs e)
        {
            ...
            if(nv.Login_DangNhap(txt_TenDN.Text,txt_MatKhau.Text)==true)
            {
                ...
                Login.matKhau = txt_MatKhau.Text;               // là một cái biên đẻ kiểm tra rthroôi rrrrrrrrr
                _frm.ShowDialog();// gọi mà hiên thị form đó lên giống show nhưng nó mạnh hơn là hiên thị lên luôn 
